...
public class AttributeStoreHandlerParameter implements HandlerParameter {

    private static final HandlerParameter INSTANCE = new AttributeStoreHandlerParameter();
    ...
    public @Nullable Object extract(@NotNull ExecutionContext context, @NotNull ArgumentCursor cursor) {
        return context.getAttributeStore();
    }
}
